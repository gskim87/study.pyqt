...
class TreeWidgetWithWidgetItems(QDialog):
    ...
    def init_ui(self):
        ...
        self.childButton_4 = QPushButton("-")
        ...
        self.treeWidget.setItemWidget(self.topLevelItem, 0, QLabel('조건'))
        ...
        self.treeWidget.setItemWidget(self.childItems[0], 3, self.childButton_4)
